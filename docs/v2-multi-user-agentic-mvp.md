...
V2-M01 is the next implementation assignment. V2-007 and pure V2-010A work may
proceed independently only when it does not encode the old singleton-owner
assumption.
