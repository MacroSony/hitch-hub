...
const deliverySchema = z.object({
  ...
  checkpoint_batch_ms: z.number().int().min(0).default(10_000),
  checkpoint_max_wait_ms: z.number().int().min(0).default(30_000),
  checkpoint_max_digests_per_turn: z.number().int().min(1).max(20).default(3),
  checkpoint_max_chars: z.number().int().min(200).max(3_900).default(1_000),
...
export const configSchema = z.object({
  ...
  delivery: deliverySchema.default({
    ...
    checkpoint_batch_ms: 10_000,
    checkpoint_max_wait_ms: 30_000,
